...
class Trade(TimeMixin, models.Model):
    ...
    exited_time = models.DateTimeField(verbose_name="Trade end time", null = True, blank =  True)
    ...
    def __str__(self):
        return f'{self.symbol} trade taken at {self.created_at}'
    
    class Meta:
        verbose_name = "Trade"
        verbose_name_plural = "Trades"

        ordering = ['created_at', 'account', 'symbol', ]
